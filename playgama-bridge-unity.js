...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/fd6037acef7cb78463efbbd924df70cf.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/a63fa0c03f1270ea930686753d4b28a4.data.unityweb',
                        frameworkUrl: 'Build/69e59f230ad9ce3b0a91ae444589d6a4.framework.js.unityweb',
                        codeUrl: 'Build/9e627a5112e47cbc4a0b25c18f5be026.wasm.unityweb',
